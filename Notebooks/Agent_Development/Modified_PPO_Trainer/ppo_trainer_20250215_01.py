        ...
        for game_number in range(1, num_games_to_train + 1):
            ...
            while game_end is False:
                ...
                with torch.no_grad():
                    ...
                    del (
                        player_0_gen_output, player_1_gen_output,
                        player_0_logprob, player_1_logprob, player_0_full_value, player_1_full_value, player_0_value, player_1_value, player_0_score, player_1_score,
                        player_0_unwrapped_model, player_1_unwrapped_model
                    )
                    torch.cuda.empty_cache()
                    gc.collect()
